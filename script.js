(function() {
  ...
  // Rectangle 1
  {
    ...
    canvas_0.addEventListener('mouseup', handleMouseUp_0, false);
    canvas_0.addEventListener('touchend', handleMouseUp_0, false);
  ...
  // Rectangle 2
  {
    ...
    canvas_1.addEventListener('mouseup', handleMouseUp_1, false);
    canvas_1.addEventListener('touchend', handleMouseUp_1, false);
  ...
  // Rectangle 1
  {
    ...
    canvas_2.addEventListener('mouseup', handleMouseUp_2, false);
    canvas_2.addEventListener('touchend', handleMouseUp_2, false);
